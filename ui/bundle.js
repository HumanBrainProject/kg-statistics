...
riot.tag2('kg-provenance-toggle', '<div> <div class="group-view__toggle"> <button class="group-view__toggle__button {selected: showProvenanceLinks}" onclick="{toggle}"> <i class="fa fa-check"></i> </button> <button class="group-view__toggle__button {selected: !showProvenanceLinks}" onclick="{toggle}"> <i class="fa fa-close"></i> </button> </div> <span>show provenance links</span> </div>', 'kg-provenance-toggle,[data-is="kg-provenance-toggle"]{ display:block; color: white; } kg-provenance-toggle .group-view__toggle,[data-is="kg-provenance-toggle"] .group-view__toggle{ height: 24px; display: inline-grid; grid-template-columns: repeat(2, 24px); margin: 3px 0; border-radius: 20px; background: #333; } kg-provenance-toggle button.group-view__toggle__button,[data-is="kg-provenance-toggle"] button.group-view__toggle__button{ -webkit-appearance: none; display: inline-block; height: 24px; margin: 0; padding: 0; border: 0; cursor: pointer; font-size: 0.66em; text-align: center; transition: all .2s ease; background: none; line-height: 24px; color: white; outline: none; } kg-provenance-toggle button.group-view__toggle__button.selected,[data-is="kg-provenance-toggle"] button.group-view__toggle__button.selected{ transform: scale(1.12); font-size: 0.8em; background: #4f5658; color: white; border-radius: 50%; } kg-provenance-toggle span,[data-is="kg-provenance-toggle"] span{ padding-left: 3px; }', '', function(opts) {
        this.showProvenanceLinks = true;
        ...
        this.on("update", () => {
            this.showProvenanceLinks = this.stores.structure.is("PROVENANCE_LINKS_SHOW");
        });
...
riot.tag2('kg-stage-toggle', '<div> <div class="group-view__toggle"> <button class="group-view__toggle__button {selected: releasedStage}" onclick="{toggle}"> <i class="fa fa-check"></i> </button> <button class="group-view__toggle__button {selected: !releasedStage}" onclick="{toggle}"> <i class="fa fa-close"></i> </button> </div> <span>switch to release data</span> </div>', 'kg-stage-toggle,[data-is="kg-stage-toggle"]{ display:block; color: white; } kg-stage-toggle .group-view__toggle,[data-is="kg-stage-toggle"] .group-view__toggle{ height: 24px; display: inline-grid; grid-template-columns: repeat(2, 24px); margin: 3px 0; border-radius: 20px; background: #333; } kg-stage-toggle button.group-view__toggle__button,[data-is="kg-stage-toggle"] button.group-view__toggle__button{ -webkit-appearance: none; display: inline-block; height: 24px; margin: 0; padding: 0; border: 0; cursor: pointer; font-size: 0.66em; text-align: center; transition: all .2s ease; background: none; line-height: 24px; color: white; outline: none; } kg-stage-toggle button.group-view__toggle__button.selected,[data-is="kg-stage-toggle"] button.group-view__toggle__button.selected{ transform: scale(1.12); font-size: 0.8em; background: #4f5658; color: white; border-radius: 50%; } kg-stage-toggle span,[data-is="kg-stage-toggle"] span{ padding-left: 3px; }', '', function(opts) {
...
riot.tag2('kg-tabs', '<div class="tabs"> <button class="{⁗tab-btn show-search-btn ⁗ + (isTypeDetailsVisible?⁗⁗:⁗is-active⁗)}" onclick="{showSearch}"> <i class="fa fa-search" aria-hidden="true"></i> </button> <button class="{⁗tab-btn show-type-details-btn ⁗ + (isTypeDetailsVisible?⁗is-active⁗:⁗⁗)}" onclick="{showTypeDetails}"> <i class="fa fa-info" aria-hidden="true"></i> </button> </div> <div class="content"> <kg-search-panel if="{!isTypeDetailsVisible}"></kg-search-panel> <kg-type-details if="{isTypeDetailsVisible}"></kg-type-details> </div>', 'kg-tabs,[data-is="kg-tabs"]{ position: relative; width: 100%; height:100%; display: flex; flex-direction: column; padding: 15px; background: #111; color:white; } kg-tabs .tabs,[data-is="kg-tabs"] .tabs{ position: relative; width: 100%; display: flex; z-index: 1; } kg-tabs .tabs button.tab-btn,[data-is="kg-tabs"] .tabs button.tab-btn{ width: 40px; height: 40px; line-height: 40px; background: #111; border-radius: 10px 10px 0 0; appearance: none; -webkit-appearance: none; border: 1px solid #444; border-left: 0; transform: translateY(1px); outline: none; font-size: 20px; color: #ccc; padding: 0; margin: 0; text-align:center; } kg-tabs .tabs button.tab-btn:first-child,[data-is="kg-tabs"] .tabs button.tab-btn:first-child{ border-left: 1px solid #444; border-radius: 10px 0 0 0; } kg-tabs .tabs button.tab-btn:last-child,[data-is="kg-tabs"] .tabs button.tab-btn:last-child{ border-radius: 0 10px 0 0; } kg-tabs .tabs button.tab-btn.is-active,[data-is="kg-tabs"] .tabs button.tab-btn.is-active{ border-bottom-color: #111; } kg-tabs .content,[data-is="kg-tabs"] .content{ position: relative; width: 100%; flex: 1; overflow: hidden; border: 1px solid #444; }', '', function(opts) {
...
riot.tag2('kg-type-details', '<div class="selection" if="{selectedType}"> <div> <div class="actions"> <button title="{⁗Unselect type ⁗ + selectedType.name}" class="close" onclick="{unselectType}"><i class="fa fa-close"></i></button> </div> <div class="title">{selectedType.name}</div> <div class="id">{selectedType.id}</div> <div class="instances">Number of instances: <span class="occurrences">{selectedType.occurrences}</span></div> <div class="spaces" if="{selectedType.spaces.length}">Spaces: <ul> <li each="{space in selectedType.spaces}"> <i class="fa fa-cloud"></i>{space.name}<span class="occurrences">{space.occurrences}</span> </li> </ul> </div> <div class="spaces warning" if="{!selectedType.spaces.length}"><i class="fa fa-long-arrow-right"></i> type {selectedType.name} is not associated with any space.</div> <hr> </div> <div class="scroll"> <div class="properties">Properties: <div class="noproperties" if="{!selectedType.properties.length}"> type {selectedType.id} does not have any property. </div> <ul if="{selectedType.properties.length}"> <li each="{property in selectedType.properties}" title="{property.id}"> {property.name} <span class="occurrences">{property.occurrences}</span> <div if="{property.targetTypes.length}"> <ul class="links"> <li each="{targetType in property.targetTypes}" title="{targetType.id}"> <span if="{property.excludeLinks}" class="{targetType.isUnknown?⁗broken-link⁗:⁗⁗}" title="{⁗links are not available in the graph for property ⁗ + property.name}"><i class="{⁗fa ⁗ + (targetType.isUnknown?⁗fa-unlink⁗:⁗fa-ban⁗)}"></i>&nbsp;<span class="link-disabled">{targetType.name}</span></span> <span if="{!property.excludeLinks && targetType.isExcluded}" class="{targetType.isUnknown?⁗broken-link⁗:⁗⁗}" title="{⁗type ⁗ + targetType.id + ⁗ is not available in the graph⁗}"><i class="{⁗fa ⁗ + (targetType.isUnknown?⁗fa-unlink⁗:⁗fa-ban⁗)}"></i>&nbsp;<span class="link-disabled">{targetType.name}</span></span> <span if="{!property.excludeLinks && !targetType.isExcluded && targetType.isUnknown}" class="{targetType.isUnknown?⁗broken-link⁗:⁗⁗}" title="{targetType.id + ⁗ is an unknown link⁗}"><i class="fa fa-unlink"></i>{targetType.name}</span> <span if="{!property.excludeLinks && !targetType.isExcluded && !targetType.isUnknown}"><i class="{⁗fa ⁗ + (targetType.isProvenance?⁗fa-flag⁗:⁗fa-long-arrow-right⁗)}"></i><a href="#" onmouseover="{highlightTarget}" onmouseout="{unhighlightTarget}" onclick="{selectTarget}" title="{targetType.id}">{targetType.name}</a></span> </li> </ul> </div> </li> </ul> </div> <div class="relations">Links To: <div class="norelations" if="{!selectedType.linksTo.length}"> type {selectedType.id} is not linking to any type. </div> <ul class="links" if="{selectedType.linksTo.length}"> <li each="{linkTo in selectedType.linksTo}" title="{linkTo.targetId}"> <span if="{linkTo.isUnknown}" title="{linkTo.targetId + ⁗ is an unknown link⁗}"><i class="fa fa-unlink"></i>{linkTo.targetName}</span> <span if="{!linkTo.isUnknown && linkTo.isExcluded}" class="{linkTo.isUnknown?⁗broken-link⁗:⁗⁗}" title="{⁗type ⁗ + linkTo.targetId + ⁗ is not available in the graph⁗}"><i class="{⁗fa ⁗ + (linkTo.isUnknown?⁗fa-unlink⁗:⁗fa-ban⁗)}"></i>&nbsp;<span class="link-disabled">{linkTo.targetName}</span></span> <span if="{!linkTo.isUnknown && !linkTo.isExcluded}"><i class="{⁗fa ⁗ + (linkTo.isProvenance?⁗fa-flag⁗:⁗fa-long-arrow-right⁗)}"></i><a href="#" onmouseover="{highlightLinkTo}" onmouseout="{unhighlightLinkTo}" onclick="{selectLinkTo}" title="{linkTo.targetId}">{linkTo.targetName}</a><span class="occurrences">{linkTo.occurrences}</span></span> </li> </ul> </div> <div class="relations">Links From: <div class="norelations" if="{!selectedType.linksFrom.length}"> type {selectedType.id} is not linked by any type. </div> <ul class="links" if="{selectedType.linksFrom.length}"> <li each="{linkFrom in selectedType.linksFrom}" title="{linkFrom.sourceId}"> <span if="{linkFrom.isUnknown}" title="{linkFrom.sourceId + ⁗ is an unknown link⁗}"><i class="fa fa-unlink"></i>{linkFrom.sourceName}</span> <span if="{!linkFrom.isUnknown && linkFrom.isExcluded}" class="{linkFrom.isUnknown?⁗broken-link⁗:⁗⁗}" title="{⁗type ⁗ + linkFrom.sourceId + ⁗ is not available in the graph⁗}"><i class="{⁗fa ⁗ + (linkFrom.isUnknown?⁗fa-unlink⁗:⁗fa-ban⁗)}"></i>&nbsp;<span class="link-disabled">{linkFrom.sourceName}</span></span> <span if="{!linkFrom.isUnknown && !linkFrom.isExcluded}"><i class="{⁗fa ⁗ + (linkFrom.isProvenance?⁗fa-flag⁗:⁗fa-long-arrow-left⁗)}"></i><a href="#" onmouseover="{highlightLinkFrom}" onmouseout="{unhighlightLinkFrom}" onclick="{selectLinkFrom}" title="{linkFrom.sourceId}">{linkFrom.sourceName}</a><span class="occurrences">{linkFrom.occurrences}</span></span> </li> </ul> </div> </div> </div> <div class="no-selection" if="{!selectedType}"> <p>Select a type on the graph or on the search panel to display its properties</p> </div>', 'kg-type-details,[data-is="kg-type-details"]{ display: block; position: relative; width: 100%; height: 100%; padding-bottom: 15px; background: #111; color:white; } kg-type-details .scroll::-webkit-scrollbar-track,[data-is="kg-type-details"] .scroll::-webkit-scrollbar-track{ -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3); background-color: #222; } kg-type-details .scroll::-webkit-scrollbar,[data-is="kg-type-details"] .scroll::-webkit-scrollbar{ width: 10px; background-color: #F5F5F5; } kg-type-details .scroll::-webkit-scrollbar-thumb,[data-is="kg-type-details"] .scroll::-webkit-scrollbar-thumb{ background-color: #000000; border-radius: 5px; } kg-type-details .selection,[data-is="kg-type-details"] .selection{ display: flex; flex-direction: column; height: 100%; } kg-type-details .selection hr,[data-is="kg-type-details"] .selection hr{ border-width: 0.3px; border-color: #444; } kg-type-details .selection > div,[data-is="kg-type-details"] .selection > div{ padding: 0 15px; } kg-type-details .selection .scroll,[data-is="kg-type-details"] .selection .scroll{ flex: 1; overflow-y: auto; } kg-type-details .no-selection,[data-is="kg-type-details"] .no-selection{ padding: 5px 20px; text-align: center; } kg-type-details .no-selection p i,[data-is="kg-type-details"] .no-selection p i{ font-style: italic; text-align: justify; } kg-type-details .no-selection p + p,[data-is="kg-type-details"] .no-selection p + p{ margin-top: 50px; } kg-type-details .title,[data-is="kg-type-details"] .title{ font-size:1.2em; line-height: 1.6em; margin: 15px 50px 12px 0; word-break: break-word; } kg-type-details .id,[data-is="kg-type-details"] .id{ font-size:0.6em; line-height: 1em; margin-bottom:12px; word-break: break-word; } kg-type-details .spaces,[data-is="kg-type-details"] .spaces{ margin-bottom:6px; } kg-type-details .warning,[data-is="kg-type-details"] .warning{ color: red; } kg-type-details .spaces ul,[data-is="kg-type-details"] .spaces ul{ list-style-type: none; margin: 6px 0 12px 0; padding-left: 5px; } kg-type-details .spaces ul li,[data-is="kg-type-details"] .spaces ul li{ margin-right: 3px; } kg-type-details .spaces ul li i.fa:before,[data-is="kg-type-details"] .spaces ul li i.fa:before{ margin-right: 5px; } kg-type-details .instances,[data-is="kg-type-details"] .instances{ font-size:0.8em; line-height: 1.2em; margin-bottom:12px; } kg-type-details .instances button,[data-is="kg-type-details"] .instances button{ position: absolute; margin: -10px 0 0 8px; padding: 10px 20px; background: #3498db; border: 0; border-radius: 3px; background-color: #3498db; background-image: linear-gradient(to bottom, #3498db, #2980b9); color: #e6e6e6; font-size: 18px; line-height: 20px; text-align: center; text-decoration: none; transition: background-color 0.3s ease-in, background-image 0.3s ease-in, color 0.3s ease-in; cursor: pointer; } kg-type-details .instances button:hover,[data-is="kg-type-details"] .instances button:hover{ background-color: #3cb0fd; background-image: linear-gradient(to bottom, #3cb0fd, #3498db); color: #ffffff; text-decoration: none; } kg-type-details .link-disabled,[data-is="kg-type-details"] .link-disabled{ text-decoration: line-through; color: #9a9a9a; } kg-type-details .norelations,[data-is="kg-type-details"] .norelations{ margin:12px 12px 16px 12px; font-size:0.8em; word-break: break-word; } kg-type-details .noproperties,[data-is="kg-type-details"] .noproperties{ margin:12px 12px 16px 12px; font-size:0.8em; word-break: break-word; } kg-type-details ul,[data-is="kg-type-details"] ul{ font-size:0.8em; padding-left:18px; } kg-type-details li,[data-is="kg-type-details"] li{ padding: 3px 0; line-height:1; position:relative; } kg-type-details ul ul,[data-is="kg-type-details"] ul ul{ font-size: 1em; } kg-type-details ul.links,[data-is="kg-type-details"] ul.links{ list-style-type: none; padding-left: 5px; } kg-type-details ul.links > li,[data-is="kg-type-details"] ul.links > li{ margin-right: 3px; } kg-type-details ul.links > li .broken-link,[data-is="kg-type-details"] ul.links > li .broken-link{ color: red; } kg-type-details ul.links > li .broken-link .link-disabled,[data-is="kg-type-details"] ul.links > li .broken-link .link-disabled{ color: red; } kg-type-details ul.links > li > span > i.fa:before,[data-is="kg-type-details"] ul.links > li > span > i.fa:before{ margin-right: 5px; } kg-type-details .occurrences,[data-is="kg-type-details"] .occurrences{ background-color: #444; display: inline-block; min-width: 21px; margin-left: 3px; padding: 3px 6px; border-radius: 12px; font-size: 10px; text-align: center; font-weight:bold; line-height:1.2; } kg-type-details .disabled,[data-is="kg-type-details"] .disabled{ text-decoration: line-through; color:#aaa; } kg-type-details .actions,[data-is="kg-type-details"] .actions{ position:absolute; top:1px; right:1px; } kg-type-details .actions button,[data-is="kg-type-details"] .actions button{ display:block; width:40px; height:40px; line-height: 40px; background: transparent; appearance: none; -webkit-appearance: none; border: none; outline: none; font-size: 20px; color: #c9cccf; padding: 0; margin: 0; text-align:center; border-bottom:1px solid #111; transition: color 0.2s ease-in, box-shadow 0.2s ease-in; } kg-type-details .actions button:hover,[data-is="kg-type-details"] .actions button:hover{ background: transparent; color: white; box-shadow: 3px 3px 6px black; } kg-type-details .actions button:first-child,[data-is="kg-type-details"] .actions button:first-child{ border-top-left-radius: 5px; border-top-right-radius: 5px; } kg-type-details .actions button:last-child,[data-is="kg-type-details"] .actions button:last-child{ border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-bottom:none; } kg-type-details .properties > ul > li,[data-is="kg-type-details"] .properties > ul > li{ margin-bottom: 4px; padding: 3px 3px; background: #222; }', '', function(opts) {
        this.selectedType = undefined;
